        ...
        <div className='relative w-full min-h-screen bg-third'>
            ...
            <div ref={introRef} className='w-full min-h-min flex flex-col items-center md:flex-row'>
                ...
                <div className='flex flex-col items-center text-center align-middle relative md:left-[-50px] md:bottom-[-65px] xl:left-[0px]'>
                    <h1 className='text-3xl text-fourth font-bold relative bottom-[4rem] xl:text-6xl'>Hi, i am <span className='text-primary'>William</span></h1>
                    <h1 className='text-3xl text-fourth font-bold relative bottom-[4rem] xl:text-6xl'>Cyber Security Enthusiast</h1>
                    <div className='col-span-3 relative bottom-[2rem] '>
                        <a href="https://www.linkedin.com/in/william-juvent-617509231/" className='text-4xl mx-4 xl:text-5xl'><FontAwesomeIcon icon={faLinkedin} /></a>
                        <a href="https://github.com/williamjvnt" className='text-4xl mx-4 xl:text-5xl'><FontAwesomeIcon icon={faGithub}/></a>
                        <a href='https://www.instagram.com/williamjvnt/' className='text-4xl mx-4 xl:text-5xl'><FontAwesomeIcon icon={faInstagram} /></a>
                    </div>
                </div> 
            </div>
            ...
            <div ref={aboutRef} className='w-full min-h-fit flex flex-col items-center text-center px-5 md:flex-row'>
                ...
                <h1 className='text-2xl text-fourth font-bold relative bottom-[4rem] md:hidden'>Hi My Name is William Juvent</h1>
                <br />
                <p className=' text-fourth font-semi-bold relative bottom-[5rem] md:hidden'>I really love drinking coffee and have a deep passion for technology. Currently, I am on a journey to learn about web and mobile development, but my biggest interest in technology is cybersecurity. I am dedicated to understanding the intricacies of protecting digital information and hope to contribute to the advancement of the technology world.</p>
            </div>
